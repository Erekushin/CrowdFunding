...
class GlobalVariables {
  ...
  static storageToVar() {
    ...
    GlobalVariables.gender = userInformation['gender'];
    ...
    GlobalVariables.cLevel = userInformation['c_level'];
    GlobalVariables.isConfirmedPhone = userInformation['is_confirmed_phone_no'];
    GlobalVariables.isConfirmedEmail = userInformation['is_confirmed_email'];
  }
