        ...
        body: Column(
          children: [
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'login_name_tr'.translationWord(),
            ...
            GeregeButtonWidget(
              ...
              onPressed: () {
                // Get.to(() => const MainPageScreen());
                if (_loginController.searchText?.text != "" &&
                    _loginController.passwordTextController?.text != '') {
                  /// хэрэглэгч хурууны хээ идэвхжүүлхийг зөвшөөрөөгүй бол байнга асуухгүй
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          if (lang['key'] != "") {
                            ...
                            GlobalVariables.gStorage.write(
                                "localeLong", GlobalVariables.localeLong);
                          }
                        });
                      },
                      child: Text(
