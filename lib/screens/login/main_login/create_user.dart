  ...
  getCountryList() {
    ...
    Services().getRequest(url, true, '').then((data) {
      ...
      if (data.statusCode == 200) {
        ...
        setState(() {
          print(
              'countries buru drop iin value ${data.body['result']['items']}');
              ...
              children: [
                ...
                Obx(
                  () => DropdownButtonFormField(
                    ...
                    items: countryList.value.map((value) {
          ...
          children: [
            ...
            Container(
              ...
              child: DecoratedBox(
                ...
                child: TabBar(
                  indicatorColor: CoreColor().backgroundGreen,
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: const BorderRadius.all(Radius.circular(10)),
                borderSide:
                    BorderSide(color: CoreColor().backgroundGreen, width: 1.2),
              ),
            ),
          ),
          const SizedBox(height: 20),
