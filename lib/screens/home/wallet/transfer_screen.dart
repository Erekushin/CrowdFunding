...
class _TransferScreenState extends State<TransferScreen> {
  ...
  //           '${CoreUrl.serviceUrl}/auth/user/find/user', true)
  //       .then((data) {
  //     var res = json.decode(data.body);
  //     print('finduser: $res');
  //     if (res['code'] == 200) {
  //       if (type == false) {
  //         numberController.text = res['result']['phone'];
  //       }
  //       usernameController.text = res['result']['first_name'];
  //       destUserId = res['result']['id'];
  //       destAccountNo = res['result']['account'];
  //     } else {
  //       Get.snackbar(
  //         'warning_tr'.translationWord(),
  //         res['message'].toString().translationWord(),
  ...
  //   Services()
  //       .postRequest(json.encode(bodyData),
  //           '${CoreUrl.serviceUrl}/txn/txn/pay/send', true)
  //       .then((data) {
  //     var res = json.decode(data.body);
  //     print('getAccountBalance: $res');
  //     if (res['code'] == 200) {
  //       priceController.text = '0';
